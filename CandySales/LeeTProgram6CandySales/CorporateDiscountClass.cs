...
{
    class CorporateDiscountClass : CalculateOrderClass
    {
        ...
        public CorporateDiscountClass(SingleOrderObject singleSaleObject, bool customerAccumulate)
