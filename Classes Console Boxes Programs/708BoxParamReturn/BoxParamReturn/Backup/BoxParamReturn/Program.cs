...
namespace BoxParamReturn
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            int volume;
            volume = someBox.FindVolume();          // returns volume to int volume (VIA FindVolume METHOD)
            someBox.ShowVolume(volume);             // passes the volume to ShowVolume method (FOR OUTPUT FROM METHOD)
            ...
            volume = anotherBox.FindVolume();
            anotherBox.ShowVolume(volume);
