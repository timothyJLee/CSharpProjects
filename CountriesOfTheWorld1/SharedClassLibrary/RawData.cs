    ...
    public class RawData
    {
        ...
        public bool Input1Record()
        {
            ...
            if (theLine != null)
            {
                ...
                Code = lineSplit[0].Substring(31, 3);
                Name = lineSplit[1].Substring(1, lineSplit[1].Length - 2);
                Continent = lineSplit[2].Substring(1, lineSplit[2].Length - 2);
                //Region = lineSplit[3].Substring(1, lineSplit[2].Length - 1);
                SurfaceArea = lineSplit[4];
                //YearOfIndep = lineSplit[5];
                Population = lineSplit[6];
                LifeExpectancy = lineSplit[7];
                count++;
                return true;
            }
            else
