/* PROJECT: WorldDataAppCS ASSN #3 (C#)         PROGRAM: AutoTesterUtility
 * AUTHOR: Timothy Lee / CS3310
 * Programs Used CLASSES USED (for Asgn 3):  SetupProgram, UserApp, SnapShotUtility, TheLog
...
namespace CountriesOfTheWorldA3
{
    public class AutoTesterUtility
    {
        ...
        {//Delete the SINGLE output Log.txt file (if it exists) and create new file
            ...
            for (int i = 8; i < 9; i++) // For statement to cycle through runs of programs
            {
                DeleteFile("CountryDataTable.bin");

                // Run All Coded Programs
                SetupProgram.SetupProgram.Main(new string[] { "A3" });
